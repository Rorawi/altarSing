...
export default function RehearsalClient({ songs }: { songs: Song[] }) {
  ...
  return (
    <div>
      <div className="mb-5">
        <h1 className="text-2xl font-bold text-slate-900">Rehearsal Tracker</h1>
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-center">
          <p className="text-3xl font-bold text-amber-700">{rehearsing.length}</p>
          <p className="text-xs text-amber-600 mt-1 font-medium">Currently Rehearsing</p>
        </div>
        <div className="bg-green-50 border border-green-200 rounded-2xl p-4 text-center">
          <p className="text-3xl font-bold text-green-700">{complete.length}</p>
          <p className="text-xs text-green-600 mt-1 font-medium">Rehearsal Complete</p>
        </div>
      </div>
